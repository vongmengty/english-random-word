export const phoneticSpellings: Record<string, string> = {
  ...
  derive: "/dɪˈraɪv/",
  elaborate: "/iˈlæb.ə.reɪt/",
  foster: "/ˈfɑː.stɚ/",
  inherent: "/ɪnˈher.ənt/",
  scrutiny: "/ˈskruː.tən.i/",
  viable: "/ˈvaɪ.ə.bəl/",
  abstruse: "/æbˈstruːs/",
  confluence: "/ˈkɑːn.flu.əns/",
  disparate: "/ˈdɪs.pɚ.ət/",
  incontrovertible: "/ˌɪn.kɑːn.trəˈvɝː.tə.bəl/",
  laconic: "/ləˈkɑː.nɪk/",
  mellifluous: "/məˈlɪf.lu.əs/",
  obfuscate: "/ˈɑːb.fə.skeɪt/",
  proclivity: "/proʊˈklɪv.ə.ti/",
  write: "/raɪt/",
  young: "/jʌŋ/"
};
